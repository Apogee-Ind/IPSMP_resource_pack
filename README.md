...
```
/give Rei_Shards minecraft:amethyst_shard[minecraft:custom_name={"text":"Amethyst Crown"},minecraft:lore=[{"color":"dark_aqua","text":"line1"},{"color":"gray","text":"line2"}],minecraft:custom_model_data={floats:[115]},minecraft:equippable={slot:head,swappable:false,asset_id:"fpack:amethyst"}] 64
```

If you want to get an item that is normal and just retextured with lore.
```
/give Rei_Shards minecraft:iron_nugget[minecraft:custom_name={"text":"key_1"},minecraft:lore=[{"color":"dark_aqua","text":"first line of text"},{"color":"gray","text":"second line of text"}],minecraft:custom_model_data={floats:[121]},asset_id:"fpack:key_1"}] 64
```
